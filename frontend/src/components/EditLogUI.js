...
function EditLogUI()
{
    ...
    return(
        <div id="editLogUIDiv">
            <form className="editForm" onSubmit={doEdit}>
                ...
                <div className="editLogDivBottom">
                    <Link to="/homepage" className="editCancelButton">Cancel</Link>
                    <input type="submit" id="editLogButton" class="buttons" value = "Edit"
                        onClick={doEdit} /><br />
                </div>
                
                <span id="editLogResult">{message}</span>
            </form>
        </div>
    );
};

export default EditLogUI;
